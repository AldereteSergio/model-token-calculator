...
const INITIAL_MODELS = [
  { id: '1', name: 'nvidia/nemotron-3-ultra-550b-a55b', inputPrice: 0.50, outputPrice: 2.50, cachePrice: 0.50 },
  { id: '2', name: 'minimax/minimax-m3', inputPrice: 0.60, outputPrice: 2.40, cachePrice: 0.12 },
  { id: '3', name: 'qwen/qwen3.7-max', inputPrice: 2.50, outputPrice: 7.50, cachePrice: 0.50 },
  { id: '4', name: 'google/gemini-3.5-flash', inputPrice: 1.50, outputPrice: 9.00, cachePrice: 0.15 },
  { id: '5', name: 'google/gemini-3.1-flash-lite', inputPrice: 0.25, outputPrice: 1.50, cachePrice: 0.025 },
  { id: '6', name: 'x-ai/grok-4.3', inputPrice: 1.25, outputPrice: 2.50, cachePrice: 1.25 },
  { id: '7', name: 'qwen/qwen3.6-flash', inputPrice: 0.25, outputPrice: 1.50, cachePrice: 0.025 },
  { id: '8', name: 'deepseek/deepseek-v4-pro', inputPrice: 0.435, outputPrice: 0.87, cachePrice: 0.003625 },
  { id: '9', name: 'deepseek/deepseek-v4-flash', inputPrice: 0.0983, outputPrice: 0.1966, cachePrice: 0.0197 },
  { id: '10', name: 'moonshotai/kimi-k2.6', inputPrice: 0.95, outputPrice: 4.00, cachePrice: 0.25 },
  { id: '11', name: 'z-ai/glm-5.1', inputPrice: 0.98, outputPrice: 3.08, cachePrice: 0.182 },
  { id: '12', name: 'minimax/minimax-m2.7', inputPrice: 0.30, outputPrice: 1.20, cachePrice: 0.06 },
  { id: '13', name: 'google/gemini-3.1-flash-lite-preview', inputPrice: 0.25, outputPrice: 1.50, cachePrice: 0.025 },
  { id: '14', name: 'google/gemini-3.1-pro-preview', inputPrice: 2.00, outputPrice: 12.00, cachePrice: 0.20 },
  { id: '15', name: 'minimax/minimax-m2.5', inputPrice: 0.15, outputPrice: 1.15, cachePrice: 0.03 },
  { id: '16', name: 'moonshotai/kimi-k2.5', inputPrice: 0.40, outputPrice: 1.90, cachePrice: 0.09 },
  { id: '17', name: 'google/gemini-3-flash-preview', inputPrice: 0.50, outputPrice: 3.00, cachePrice: 0.05 }
];
